...
TARGET_DIR="/mfs1/u/levmckinney/experiments/oocr-inf/outputs/2025_08_14_03-35-05_SWEEP_mKBDr_train_on_fact_documents_train_extractive/2025_08_14_03-35-23_IpWCC_2025_08_14_03-35-05_SWEEP_mKBDr_train_on_fact_documents_train_extractive_index_0_cached_synthetic_docs_hop_num_epochs_1_lr_0.0001"

python -m shared_ml.cli.slurm_sweep \
    --script_name 'run_influence' \
    --experiment_name 'influence_on_fact_documents' \
    --sweep_name 'inf_across_checkpoints' \
    --target_experiment_dir $TARGET_DIR \
    --checkpoint_name_sweep '["checkpoint_start", "checkpoint_e1_s97", "checkpoint_e1_s194", "checkpoint_e1_s291", "checkpoint_e1_s388", "checkpoint_final"]' \
